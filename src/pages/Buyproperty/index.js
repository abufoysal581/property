...
const getDatas = async () => {
    try {
        const response = await axios.get(`${process.env.REACT_APP_API_URL}/property?listing_type=sale`);
                      ...
                      <div className="col-md-4" style={{paddingTop:"20px"}} key={d.id}>
                        <div className="product-item">
                          ...
                          <div className="row">
                            ...
                            <Link to={`/property/${d.id}`} className="btn btn-primary py-2 px-3" > See details </Link>
                            </div> 
                            <div className="col-md-6">
                              <Link to={`/buyform/${d.id}`} className="btn btn-primary py-2 px-3" > Buy Property </Link>
                            </div> 
                          </div>
                        </div>
                      </div>
